...
#Elith, Jane, John R. Leathwick, and Trevor Hastie. "A working guide to boosted 
#regression trees." Journal of animal ecology 77.4 (2008): 802-813.
...
function (data,                             # the input dataframe
  ...
  tolerance = 0.00001,                        # tolerance value to use - if method == fixed is absolute, 
